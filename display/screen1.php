                                ...
                                <tbody class="text-center"  id="table1">
                                    ...
                                    <?php 
                                        ...
                                        switch($hr)
                                        {
                                            ...
                                            case 7:
                                                $acum_plan   = $row[4]+$row[5];
                                                $acum_actual = $row[38]+$row[39];
                                            break;

                                            case 8:
                                                $acum_plan   = $row[4]+$row[5]+$row[6];
                                                $acum_actual = $row[38]+$row[39]+$row[40];
                                            break;

                                            case 9:
                                                $acum_plan   = $row[4]+$row[5]+$row[6]+$row[7];
                                                $acum_actual = $row[38]+$row[39]+$row[40]+$row[41];
                                            break;

                                            case 10:
                                                $acum_plan   = $row[4]+$row[5]+$row[6]+$row[7]+$row[8];
                                                $acum_actual = $row[38]+$row[39]+$row[40]+$row[41]+$row[42];
                                            break;

                                            case 11:
                                                $acum_plan   = $row[4]+$row[5]+$row[6]+$row[7]+$row[8]+$row[9];
                                                $acum_actual = $row[38]+$row[39]+$row[40]+$row[41]+$row[42]+$row[43];
                                            break;

                                            case 12:
                                                $acum_plan   = $row[4]+$row[5]+$row[6]+$row[7]+$row[8]+$row[9]+$row[10];
                                                $acum_actual = $row[38]+$row[39]+$row[40]+$row[41]+$row[42]+$row[43]+$row[44];
                                            break;

                                            case 13:
                                                $acum_plan   = $row[4]+$row[5]+$row[6]+$row[7]+$row[8]+$row[9]+$row[10]+$row[11];
                                                $acum_actual = $row[38]+$row[39]+$row[40]+$row[41]+$row[42]+$row[43]+$row[44]+$row[45];
                                            break;

                                            case 14:
                                                $acum_plan   = $row[4]+$row[5]+$row[6]+$row[7]+$row[8]+$row[9]+$row[10]+$row[11]+$row[12];
                                                $acum_actual = $row[38]+$row[39]+$row[40]+$row[41]+$row[42]+$row[43]+$row[44]+$row[45]+$row[46];
                                            break;

                                            case 15:
                                                $acum_plan   = $row[4]+$row[5]+$row[6]+$row[7]+$row[8]+$row[9]+$row[10]+$row[11]+$row[12]+$row[13];
                                                $acum_actual = $row[38]+$row[39]+$row[40]+$row[41]+$row[42]+$row[43]+$row[44]+$row[45]+$row[46]+$row[47];
                                            break;
                                            ...
                                            case 17:
                                                $acum_plan   = $row[14]+$row[15];
                                                $acum_actual = $row[48]+$row[49];
                                            break;

                                            case 18:
                                                $acum_plan   = $row[14]+$row[15]+$row[16];
                                                $acum_actual = $row[48]+$row[49]+$row[50];
                                            break;

                                            case 19:
                                                $acum_plan   = $row[14]+$row[15]+$row[16]+$row[17];
                                                $acum_actual = $row[48]+$row[49]+$row[50]+$row[51];
                                            break;

                                            case 20:
                                                $acum_plan   = $row[14]+$row[15]+$row[16]+$row[17]+$row[18];
                                                $acum_actual = $row[48]+$row[49]+$row[50]+$row[51]+$row[52];
                                            break;

                                            case 21:
                                                $acum_plan   = $row[14]+$row[15]+$row[16]+$row[17]+$row[18]+$row[19];
                                                $acum_actual = $row[48]+$row[49]+$row[50]+$row[51]+$row[52]+$row[53];
                                            break;

                                            case 22:
                                                $acum_plan   = $row[14]+$row[15]+$row[16]+$row[17]+$row[18]+$row[19]+$row[20];
                                                $acum_actual = $row[48]+$row[49]+$row[50]+$row[51]+$row[52]+$row[53]+$row[54];
                                            break;

                                            case 23:
                                                $acum_plan   = $row[14]+$row[15]+$row[16]+$row[17]+$row[18]+$row[19]+$row[20]+$row[21];
                                                $acum_actual = $row[48]+$row[49]+$row[50]+$row[51]+$row[52]+$row[53]+$row[54]+$row[55];
                                            break;
                                            ...
                                            case 1:
                                                $acum_plan   = $row[22]+$row[23];
                                                $acum_actual = $row[56]+$row[57];
                                            break;

                                            case 2:
                                                $acum_plan   = $row[22]+$row[23]+$row[24];
                                                $acum_actual = $row[56]+$row[57]+$row[58];
                                            break;

                                            case 3:
                                                $acum_plan   = $row[22]+$row[23]+$row[24]+$row[25];
                                                $acum_actual = $row[56]+$row[57]+$row[58]+$row[59];
                                            break;

                                            case 4:
                                                $acum_plan   = $row[22]+$row[23]+$row[24]+$row[25]+$row[26];
                                                $acum_actual = $row[56]+$row[57]+$row[58]+$row[59]+$row[60];
                                            break;

                                            case 5:
                                                $acum_plan   = $row[22]+$row[23]+$row[24]+$row[25]+$row[26]+$row[27];
                                                $acum_actual = $row[56]+$row[57]+$row[58]+$row[59]+$row[60]+$row[61];
                                            break;
