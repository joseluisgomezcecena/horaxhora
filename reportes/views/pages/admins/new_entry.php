                ...
                <div id="disp">
                    <div class="row">
                        ...
                        <div class="form-group col-lg-2">
                            ...
                            <input id="video" class=" form-control" type="number"  name="quantity" step=".01"   required/>
                        ...
                        <div class="form-group col-lg-12">
                            ...
                            <small>Video description <i style="color:red">*</i></small>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-lg-4">
                            ...
                            <input id="video" class=" form-control" type="number"  name="days"    required/>
                            <small>Number of parts <i style="color:red">*</i></small>
                        </div>

                        
                        <div class="form-group col-lg-4">
                            <label for="revision">Responsible User</label>
                            <input class="login_input form-control" type="text" name="user_name" list="users" autocomplete="off" required>
                            <datalist id="users">
                                <?php
                        ...
                        <div class="form-group col-lg-4">
                            <label for="revision">Department</label>
                            <select class="login_input form-control" type="text" name="responsible_dept_id"  autocomplete="off" required>
