        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                <table style="font-size: 12px;" class="table table-hover" id="dataTable" width="100%" cellspacing="0">
                    ...
                    $query = "SELECT * FROM incoming_log LEFT JOIN measures ON measures.id_measure = incoming_log.measure_id WHERE responsible_dept_id = $department_id AND rejected = 1;";
