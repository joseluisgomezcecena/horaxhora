...
<div class="row">
    <div class="col-xl-12 col-lg-7">
        <div class="card shadow mb-4">
            ...
            <!-- Card Body -->
            <div class="card-body">
                <table style="font-size: 12px; text-align:left;" class="table table-hover" id="dataTable" width="100%" cellspacing="0">
                    <thead>
                    <tr>
                        <th>Date</th>
                        <th>End</th>
                    ...
                    <tbody  style="text-align:left;" class="left">

                    <?php
                    $today = date("Y-m-d");
                    $query = "SELECT * FROM incoming_log LEFT JOIN measures as measures ON measures.id_measure = incoming_log.measure_id WHERE out_quarantine = 0 AND responsible_dept_id = $department_id AND viewed = 0; ";
                        ...
                        <tr>
                            ...
                            <td style="text-align:left;" class="left">
                              ...
                              else
                              {
                                  if($rejected == 1)
                                  {
                                    echo "<b class='text-center'><p class='text-dark'><i class='fa fa-times text-danger'></i>Rejected</p></b>";
                                  }
                                  else
                                  {
                            ...
                            <td>
                              ...
                              ?>
                                <form method="post">
                                <input type="hidden" name="incoming_id" value="<?php echo $row['incoming_id'] ?>">   
                              ...
                              {
                              ?>
                                <a class="btn btn-primary" href="index.php?page=client_manage_entries&id=<?php echo $row['incoming_id'] ?>&u=client&followup=true">Update</a>
                              <?php
                              }
                              ?>
                            </td>
