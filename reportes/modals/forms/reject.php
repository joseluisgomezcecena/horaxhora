    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Reject Part:<?php echo $row_select['part'] ?> Lot:<?php echo $row_select['lot'] ?></h5>
            ...
            <div class="modal-body text-center">
                ...
                <form method="post">
                    ...
                    <input class="form-control" type="text" name="rejected_reason">
