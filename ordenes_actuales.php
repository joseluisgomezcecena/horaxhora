            ...
            <table class="table table-bordered" id="tabla-ordenes" width="100%" cellspacing="0">
                ...
                <?php 
                    ...
                    <tr id="row<?php echo $row_orders['orden_id'];?>">
                        ...
                        <td><?php echo $row_orders['fecha_inicial'];?></td>
                        <td><?php 
                        ...
                        <td style="text-align: center">
                            <button class="btn btn-success start-order" data-id="<?php echo $row_orders['orden_id'];?>">Completar <i class="fas fa-play"></i></button>
                            <button class="btn btn-warning edit-order" data-id="<?php echo $row_orders['orden_id'];?>">Interrumpir <i class="fas fa-edit"></i></button>
                        </td>
                    </tr>
                    <?php 
                    endwhile;
